...
from processamento.peneiras import peneirar_item
...
def extrair_links_fonte(nome_fonte, url):
    ...
    try:
        ...
        for a in links:
            ...
            analise_peneira = peneirar_item(texto_base, href)

            classe_prevista = analise_peneira["classe"]
            score_p = analise_peneira["score_peneira"]
            deve_vasculhar_item = analise_peneira["deve_vasculhar"]
            tipo_pista = analise_peneira["tipo_pista"]
            ...
            resultados.append({
                ...
                "link": href,
                "origem": url,
                "score_peneira": score_p,
                "deve_vasculhar": deve_vasculhar_item,
